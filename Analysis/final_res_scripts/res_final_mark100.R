...
# load results of this thesis settings: Markov N=100
...
load("Erdmann/results/ResultData_Scenario5_N100.rda")
...
load("Erdmann/results/ResultData_Scenario6_N100.rda")
...
load("Erdmann/results/ResultData_Scenario7_N100.rda")
...
plot_df <- rbind(plot_df,
                 ...
                 data.frame("mean" = scenario$EB2[1,],
                            ...
                            "method"  = "EB2",
                            "from" = "old"))
load("Erdmann/results/ResultData_Scenario8_N100.rda")
...
save(plot_markov100, file = "Analysis/final_res_scripts/final_results/evaluated/plot_markov100.rda")
