...
# setwd("..")
load("Erdmann/results/ResultData_Scenario9_N100.rda")
...
load("Erdmann/results/ResultData_Scenario10_N100.rda")
...
# setwd("..")
load("Erdmann/results/ResultData_Scenario11_N100.rda")
                              ...
                              ifelse(method=="spline_by=transition",
                                     ...
                                     ifelse(method=="spline_by=transition_wait",
                                            ...
                                            ifelse(method=="spline_by=transition_wait_nonmarkov",
                                                   ...
                                                   ifelse(method=="tensor_spline",
                                                          "te(tend, wait)+transition",
                                                          method)))))))  %>% 
