...
{load("Analysis/final_res_scripts/final_results/poisson100_final_results.RData")
  ...
  # pivot longer erd_pois_1_100
  erd_pois_1_100 <- erd_pois_1_100 %>% 
    pivot_longer(
      cols = c(AJ, NAE, EB1, EB2),  # Columns to pivot
      names_to = "Estimator",        # Name for new variable column
      values_to = "X100"           # Name for new values column
    ) %>% 
  ...
  # pivot longer erd_non_markov_1_100
  ...
  # pivot longer erd_non_markov_3_100
...
{load("Analysis/final_res_scripts/final_results/poisson100_final_results.RData")
  ...
  # pivot longer erd_non_markov_2_100
  ...
  # pivot longer erd_non_markov_4_100
...
# no terminating event
{
  ...
  non_mark_1_200_res <- rbind(
    ...
    data.frame("40" = (cutoff1 %>% clean_results())[seq(1, length(cutoff1 %>% clean_results()), by = 4)],
               ...
               "100" = (cutoff1 %>% clean_results())[seq(4, length(cutoff1 %>% clean_results()), by = 4)],
               Estimator = "s(tend, by=transition)+transition")# ,
    # data.frame("40 = (wait1 %>% clean_results())[seq(1, length(wait1 %>% clean_results()), by = 4)],
    #            Estimator = "s(tend, by=transition)+wait"),
    # data.frame("40 = (trynonmark1 %>% clean_results())[seq(1, length(trynonmark1 %>% clean_results()), by = 4)],
    #            Estimator = "s(tend, by=transition)+wait(nonmark)")
  )
  ...
  non_mark_3_200_res <- rbind(
    ...
    data.frame("40" = (cutoff3 %>% clean_results())[seq(1, length(cutoff3 %>% clean_results()), by = 4)],
               ...
               "100" = (cutoff3 %>% clean_results())[seq(4, length(cutoff3 %>% clean_results()), by = 4)],
               Estimator = "s(tend, by=transition)+transition")# ,
    # data.frame("40 = (wait3 %>% clean_results())[seq(1, length(wait3 %>% clean_results()), by = 4)],
    #            Estimator = "s(tend, by=transition)+wait"),
    # data.frame("40 = (trynonmark3 %>% clean_results())[seq(1, length(trynonmark3 %>% clean_results()), by = 4)],
    #            Estimator = "s(tend, by=transition)+wait(nonmark)")
  )
...
# no terminating event
{
  ...
  erd_non_markov_1_200 <- boxplotData %>% 
    mutate(scenario = "non_markov_1")
  # pivot longer erd_non_markov_1_200
  ...
  erd_non_markov_3_200 <- boxplotData %>% 
    mutate(scenario = "non_markov_3")
  # pivot longer erd_non_markov_3_200
...
# with terminating event
{
  ...
  erd_non_markov_2_200 <- boxplotData %>% 
    mutate(scenario = "non_markov_2")
  # pivot longer erd_non_markov_2_200
  ...
  erd_non_markov_4_200 <- boxplotData %>% 
    mutate(scenario = "non_markov_4")
  # pivot longer erd_non_markov_4_200
