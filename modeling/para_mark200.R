...
# normal3_notrans <- run_parallel(data, "ped_status ~ s(tend)", competing = TRUE)
# spline3 <- run_parallel(data, "ped_status ~ s(tend, by = transition) + transition", competing = TRUE)
cutoff3 <- run_parallel(data, "ped_status ~ s(tend, by = transition) + transition", cutoff = TRUE, competing = TRUE)
# wait3 <- run_parallel(data, "ped_status ~ s(tend, by = transition) + transition", cutoff = TRUE, wait = TRUE, competing = TRUE)
